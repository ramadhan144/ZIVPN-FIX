...
```bash
apt update && apt install bzip2 -y && wget -q https://raw.githubusercontent.com/ramadhan144/ZIVPN-FIX/main/install.sh && chmod +x install.sh && ./install.sh
```
...
```bash
wget -q https://raw.githubusercontent.com/ramadhan144/ZIVPN-FIX/main/uninstall.sh && chmod +x uninstall.sh && ./uninstall.sh
```
